...
stdenvNoCC.mkDerivation {
  ...
  meta = {
    description = "Note-based task management with calendar, kanban, pomodoro and time-tracking integration";
    homepage = "https://github.com/callumalpass/tasknotes";
    changelog = "https://github.com/callumalpass/tasknotes/releases/tag/${version}";
