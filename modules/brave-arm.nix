    ...
    brave.overrideAttrs (finalAttrs: previousAttrs: {
      ...
      installPhase = ''
          ...
          do
              ...
              ln -s $out/opt/brave.com/brave-nightly/product_logo_$icon_nightly.png $out/share/icons/hicolor/$icon\x$icon/apps/brave-browser.png
          done
